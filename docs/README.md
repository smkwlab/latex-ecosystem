...
このディレクトリのドキュメントは英語版（`.md`）が正で、`.ja.md` が日本語版です。
...
2. [MANAGEMENT-REPOSITORY.ja.md](MANAGEMENT-REPOSITORY.ja.md) — この管理リポジトリの構造と境界
3. [MANAGEMENT-WORKFLOWS.ja.md](MANAGEMENT-WORKFLOWS.ja.md) — 管理タスクのワークフロー
4. [SETUP-AND-RELEASE.ja.md](SETUP-AND-RELEASE.ja.md) — セットアップ・依存関係更新・リリース
5. [GIT-WORKFLOW.ja.md](GIT-WORKFLOW.ja.md) — Git 運用のベストプラクティス

## 全ドキュメント一覧

| ファイル | 読者 | 言語 |
|---|---|---|
| [GETTING-STARTED.md](GETTING-STARTED.md) / [.ja](GETTING-STARTED.ja.md) | 運用を新しく始める人 | 英 / 日 |
| [SETUP-AND-RELEASE.md](SETUP-AND-RELEASE.md) / [.ja](SETUP-AND-RELEASE.ja.md) | 維持運用者 | 英 / 日 |
| [MULTI-ORG-DEPLOYMENT.md](MULTI-ORG-DEPLOYMENT.md) / [.ja](MULTI-ORG-DEPLOYMENT.ja.md) | 新 org への展開者 | 英 / 日 |
| [MANAGEMENT-REPOSITORY.md](MANAGEMENT-REPOSITORY.md) / [.ja](MANAGEMENT-REPOSITORY.ja.md) | 維持運用者 | 英 / 日 |
