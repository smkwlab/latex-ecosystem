...
この添削フローの中核である「draft ブランチで執筆 → PR で添削 → 自動作成される次稿ブランチで改稿」の繰り返しを **draft PR サイクル**と呼びます（用語の定義は [GLOSSARY.md](GLOSSARY.md) を参照）。
...
- [学生向け使用方法](https://github.com/smkwlab/sotsuron-template/blob/main/.github/README.md)
